...
| Bagian | Tautan |
|---|---|
| Alat | [Semua kalkulator](https://defsayurinda-bot.github.io/Defsa-Yurinda/alat/) · [Latihan soal](https://defsayurinda-bot.github.io/Defsa-Yurinda/latihan/) |
...
```
konten/     tulisan sumber (Markdown): tentang, catatan, cara memakai AI, skill
