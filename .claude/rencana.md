...
- [x] Tahap 4: Tampilan (konsep A dipilih Defsa: pita oranye, stabilo, Archivo Black dan Source Sans 3; `prototipe/` hanya di branch `tahap-4/prototipe`, penghapusannya menunggu izin)
- [ ] Tahap 5: Isi dan portofolio
- [ ] Tahap 6: Standar repo populer (sebagian: README, CITATION.cff, CONTRIBUTING, SECURITY, CODE_OF_CONDUCT, templat Issue dan PR, CHANGELOG, Dependabot, permissions selesai; gambar pratinjau sosial dan README profil menyusul setelah Tahap 4, lalu selesai)
...
Lanjutan Tahap 2 (26 September 2026): rumus Reese & Wright dicocokkan dengan Lastiasih, Irsyam, Sidi, & Toha, Media Komunikasi Teknik Sipil 19(2), Desember 2013, hlm. 136 (PDF dari situs jurnal). Tahanan ujung pasir diganti dari 7N ≤ 400 t/m² menjadi (2/3)N/0,3048² untuk N ≤ 60 dan 40/0,3048² untuk N > 60. α = 0,55 dan pemotongan N ≥ 53 tetap [BELUM TERVERIFIKASI]. "Kumpulan korelasi parameter geoteknik dan fondasi" (PUPR 2019) tidak ada di daftar NSPK Bina Marga; SNI 8460:2017 di sana hanya pratinjau 5 halaman. Meyerhof tetap disembunyikan.
